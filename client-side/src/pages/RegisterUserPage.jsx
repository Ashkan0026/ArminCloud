...
export default function RegisterUserPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // Usually after register you go to login
      navigate("/login?as=user", { replace: true });
    } catch (err) {
    ...
    <div style={styles.page}>
      <header style={styles.nav}>
        ...
        <div style={styles.navRight}>
          <Link to="/login?as=user" style={styles.linkBtn}>
            Login
          </Link>
      ...
      <main style={styles.main}>
        <div style={styles.shell}>
          <div style={styles.leftPane}>
            <h1 style={styles.h1}>Create your user account</h1>
            <p style={styles.p}>
              Users can log in and access machines assigned to them. If you’re managing infrastructure,
              register as a company instead.
            </p>

            <div style={styles.infoBox}>
              <div style={styles.infoTitle}>What you’ll get</div>
              <ul style={styles.ul}>
                <li>Personal dashboard access</li>
                <li>View assigned machines</li>
                <li>Simple login flow</li>
              </ul>
            </div>

            <div style={styles.helpBox}>
              <div style={styles.helpTitle}>Need a company account?</div>
          ...
          <div style={styles.card}>
            <div style={styles.cardHeader}>
              <div style={styles.cardTitle}>User Registration</div>
              <div style={styles.cardSubtitle}>Enter your details to create an account.</div>
            </div>
            ...
            <form onSubmit={onSubmit} style={styles.form}>
              ...
              <div style={styles.smallNote}>
                ...
                <Link to="/login?as=user" style={styles.inlineLink}>
                  Login as user
                </Link>
              </div>
            </form>
